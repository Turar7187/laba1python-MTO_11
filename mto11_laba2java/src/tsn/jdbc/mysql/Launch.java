...
public class Launch {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String url = "jdbc:mysql://localhost:3306/test?serverTimezone=Asia/Almaty&useSSL=false";

            // Создание свойств соединения с базой данных
            Properties authorization = new Properties();
            authorization.put("user", "root"); // Зададим имя пользователя БД
            authorization.put("password", "turarekb01"); // Зададим пароль доступа в БД
            ...
            ResultSet table = statement.executeQuery("SELECT * FROM testt.laba;");
